...
const btnCopyValue = document.querySelector('.wallet-copy')

btnCopyValue?.addEventListener('click', function () {
  const input = document.querySelector('#wallet-address').value
...
// const btnSharecopy = Array.from(document.querySelectorAll('.modals-share-btn'))

// btnSharecopy?.forEach(element => {
//   element.addEventListener('click', function () {

//     console.log(element.previousElementSibling.innerText);
//     const copyArea = element.previousElementSibling.innerText
